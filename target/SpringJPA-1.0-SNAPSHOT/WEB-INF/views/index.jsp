            ...
            <div>
                <nav id= "navbar" class="uk-navbar-container tm-navbar-container" uk-navbar>
                    ...
                    <div class="uk-navbar-left">
                        <a class="logo uk-link-reset" href="index.html">School App</a>
            ...
            <div class="uk-container uk-container-expand">
                ...
                <div class="uk-grid-match  uk-height-1-1" uk-grid>
                    ...
                    <div class="uk-height-1-1 uk-align-center   ">
                        <h1 class="uk-heading-medium uk-text-center ">Welcome</h1>
                        <p class="uk-text-center uk-text-lead ">This is an  app which you can administrate School database </p>
