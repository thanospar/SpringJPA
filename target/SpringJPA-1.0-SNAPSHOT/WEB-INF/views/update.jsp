            ...
            <div class="uk-container uk-container-expand">
                ...
                <div class="uk-grid-match  uk-height-1-1" uk-grid>
                    ...
                    <div class="uk-height-1-1 uk-align-center   ">
                        <h4 class="uk-heading-small uk-text-center ">Update</h4>

                        <div class="uk-text-center">
                            <form:form method="POST"   modelAttribute="trainer" class="uk-form-horizontal uk-margin-large">
                                <div class="uk-margin">
                            ...
                            <div class="uk-margin">
                                ...
                                <div class="uk-form-controls">
                                    ...
                                    <input class="uk-input uk-form-width-small uk-button uk-button-primary " value="Update"  type="Submit" />
                                </div>
                            </div>
